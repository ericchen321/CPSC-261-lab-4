 ...
 *          list_5: 33 500 -52
 */
void initialize_test_lists(s_list **list_0, s_list **list_1, s_list **list_2, s_list **list_3, s_list **list_4, s_list **list_5){
  int i;
...
int main(int argc, char *argv[]) {
  ...
  struct s_list* test_list_3;
  struct s_list* test_list_4;
  struct s_list* test_list_5;    

  // tests: print_with_positions
  initialize_test_lists(&test_list_0, &test_list_1, &test_list_2, &test_list_3, &test_list_4, &test_list_5);
  print_with_positions(test_list_0);
  print_with_positions(test_list_1);
  print_with_positions(test_list_2);
  free_list(test_list_0); free_list(test_list_1); free_list(test_list_2); free_list(test_list_3); free_list(test_list_4); free_list(test_list_5);
